        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 text-left">
          ...
          <div className="lg:col-span-4 space-y-5">
            ...
            <div className="flex items-center gap-3 pt-1">
              ...
              <a href="mailto:support@stylewalk.in" className="w-8 h-8 rounded-xl bg-white/5 hover:bg-emerald-600 hover:text-white text-gray-400 flex items-center justify-center border border-white/10 transition" title="Contact Email">
